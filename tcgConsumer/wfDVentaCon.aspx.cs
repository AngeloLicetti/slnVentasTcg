...
public partial class wfDVentaCon : System.Web.UI.Page
{
    wsDVenta objProxy;
    DVenta objDVenta;
    ...
    private void mostraMjeBuscar(DVenta objDVenta)
    {
        ...
        {
            lblMje.Text = "Estos son los datos; visualize y si está seguro que desea Consultarlo pulse Consultar.";
        }
        else
        {
    ...
    private void mostrarMjeConsultar(DVenta objDVenta)
    {
        lblMje.ForeColor = objDVenta.Estado == 99 ? System.Drawing.Color.Green : System.Drawing.Color.Red;
