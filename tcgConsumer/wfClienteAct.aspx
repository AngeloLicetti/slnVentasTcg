<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="wfClienteAct.aspx.cs" Inherits="wfClienteAct" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div>
         <table class="auto-style2">
             <tr>
                <td colspan="3" class="text-center"><strong>ACTUALIZAR CLIENTE</strong></td>
             </tr>
             <tr>
                <td class="auto-style3">Codigo de Cliente:</td>
                <td colspan="2">
                   <asp:TextBox ID="txtCodigo" runat="server" Width="333px"></asp:TextBox>
                </td>
            </tr>
         </table>
    </div>
