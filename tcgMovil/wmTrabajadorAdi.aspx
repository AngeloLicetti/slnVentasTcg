<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wmTrabajadorAdi.aspx.cs" Inherits="wmTrabajadorAdi" %>
...
<body>
    <mobile:Form id="fmPrincipal" runat="server">
        ...
        <br />
        <mobile:Label ID="Label2" Runat="server">REGISTRAR TRABAJADOR</mobile:Label>
        <br />
        <mobile:Label ID="Label3" Runat="server">Codigo: </mobile:Label>
        <mobile:TextBox ID="txtCodigo" Runat="server"></mobile:TextBox>
        <mobile:Panel ID="divOcultar" Runat="server" Visible="true">
        ...
        <mobile:Command ID="btnRegistrar" Runat="server" OnClick="btnRegistrar_Click">Registrar</mobile:Command>
    </mobile:Form>
</body>
</html>
