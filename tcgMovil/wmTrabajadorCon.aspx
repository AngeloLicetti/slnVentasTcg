<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wmTrabajadorCon.aspx.cs" Inherits="wmTrabajadorCon" %>
...
<body>
    <mobile:Form id="fmPrincipal" runat="server">
        ...
        <br />
        <mobile:Label ID="Label2" Runat="server">CONSULTAR TRABAJADOR</mobile:Label>
        <br />
        ...
        <mobile:Command ID="btnConsultar" Runat="server" OnClick="btnConsultar_Click">Consultar</mobile:Command>
    </mobile:Form>
</body>
</html>
